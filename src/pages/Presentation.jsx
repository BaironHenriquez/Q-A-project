...
export default function Presentation({ session }) {
  ...
  return (
    <main className="min-h-screen bg-[#64a2cc] text-[#3f2abe] font-sans p-4 md:p-6 lg:p-8">
      <section className="grid min-h-[calc(100vh-2rem)] w-full grid-cols-1 gap-6 md:grid-cols-[380px_minmax(0,1fr)] lg:gap-7">
        <aside className="rounded-[2rem] border border-[#64a2cc] bg-[#e6f2fa] p-7 shadow-md md:p-8 lg:p-9">
        ...
        <article className="flex min-h-0 flex-col rounded-[2rem] border border-[#64a2cc] bg-[#e6f2fa] p-7 shadow-md md:p-9 lg:p-11">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight">Presentación en vivo</h1>
          ...
          <div className="mt-6 flex-1 overflow-y-auto pr-1">
            {!approvedQuestions.length && (
              <div className="rounded-3xl bg-[#e6f2fa] p-11 lg:p-16 text-center shadow-sm">
                  ...
                  return (
                    <article key={question.id} className="rounded-3xl border border-[#64a2cc] bg-[#e6f2fa] p-6 shadow-sm md:p-7">
                      ...
                      {approvedAnswers.length > 0 && (
                        <div className="mt-4 rounded-2xl border border-[#64a2cc] bg-[#e6f2fa] p-4">
                          <p className="text-[11px] font-extrabold uppercase tracking-wide text-[#3f2abe]">Respuestas aprobadas</p>
                          <div className="mt-2 flex flex-col gap-2">
                            {approvedAnswers.map((answer) => (
                              <div key={answer.id} className="rounded-xl bg-[#e6f2fa] p-4">
